...
app.use(cors({
    origin: ['http://localhost:5173', 'http://127.0.0.1:5173', 'http://localhost:3000', 'http://127.0.0.1:5500', 'http://localhost:5500'],
    credentials: true
}));
...
if (!MUX_TOKEN_ID || !MUX_TOKEN_SECRET) {
    console.error('❌ Missing Mux credentials in .env file');
    process.exit(1);
}
